...
>>> $type:
    It will sort list the documents based on fieldname and its data types.
...
db.trainers.updateOne(
  ...
  db.trainers.updateOne( { trainerName: "Amit Patel" }, { $set: { active: "YES" } });
  ...
  db.trainers.updateOne( { trainerName: "Anjali Verma" }, { $set: { active: { status: true, duration: 500000 },  },} );
