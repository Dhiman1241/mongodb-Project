...
// & WAQTD the triple salary of each manager
db.emp.find(
  { job: "manager" },
  { _id: 0, sal: 1, tripeSal: { $multiply: ["$sal", 3] } },
  {}
);
...
db.emp.find({},{_id: 0, sal: 1, ename: 1, hike: {$add : ["$sal", 200]}},{});

// & Q) WAQTD ename, salary of the employees with the hike of 250 dollars.
db.emp.find({}, {ename: 1, sal: 1, _id: 0, hike: {$add: ["$sal", 250]}}, {});
...
db.emp.find({}, {_id: 0, sal: 1, newSal: {$subtract: ["$sal", 50]}}, {});

// & WAQTD the name and salary with 100$ penalty.
db.emp.find({}, {_id: 0, ename: 1, sal: 1, newSal: {$subtract: ["$sal", 100]}}, {});

// & Q) WAQTD the name, job, and deducted salary(200$) of all salesman.
db.emp.find({job: 'salesman'},{_id: 0, ename: 1, job: 1, sal: 1, newSal: {$subtract : ["$sal", 200]}},{});

// === $multiply ===
// & Q) WAQTD the name , salary and annual salary of an employee.
db.emp.find({},{_id: 0,name: 1, sal: 1, annualSal: {$multiply: ['$sal', 12]}},{});

// & Q) WAQTD the name , salary and half yearly salary of an employee.
db.emp.find({},{_id: 0, ename: 1, sal: 1, newSal: {$multiply: ['$sal', 6]}},{});

// & Q) WAQTD the name , salary and quarterly salary of an employee.
db.emp.find({},{ename: 1, sal: 1, _id: 0, newSal: {$multiply: ['$sal', 4]}},{});
...
db.emp.find({},{_id: 0, ename: 1, sal: 1, onedaySal: {$divide: ['$sal', 30]}},{});

// & Q) WAQTD the name, salary and 15 days salary.
db.emp.find({},{ename: 1, sal: 1, _id: 0, newSal: {$divide: ['$sal', 2]}},{});
...
db.emp.find({empno: {$mod : [2,0]}},{_id: 0,empno: 1, ename: 1},{});

// & Q) WAQTD the name ,salary and annual_sal with a hike of 100.
db.emp.find({},{_id: 0, ename: 1, sal: 1, newSal: {$add : ['$sal', 100]}},{});