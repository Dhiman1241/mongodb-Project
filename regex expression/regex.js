...
Syntax: {fieldName: {$regex : /pattern/}}

text starts with --> use ^symbol ---> Ex: starts with s --> /^s/
text ends with --> use $ symbol ----> Ex: ends with s ---> /s$/
for single character  ----> use .symbol
for double character  ----> use ..symbol
for triple character  ----> use ...symbol
for four character  ----> use ....symbol and so on
...
db.emp.find({ename: {$regex: /^t..ne.$/}},{_id: 0, ename: 1});
...
db.emp.find({ ename: { $regex: /[eo]/ } },{ _id: 0, ename: 1 } ); // [] --> we can mention specific characters.

// & WAQTD the employees names contains vowels
db.emp.find({ ename: { $regex: /[aeiou]/ } },{ _id: 0, ename: 1 } ); // [] --> we can mention specific characters.

// & WAQTD the employees names contains 2 consecutive vowels
db.emp.find({ ename: { $regex: /.*[aeiou]{2}.*/ } },{ _id: 0, ename: 1 } ); // [] --> we can mention specific characters.

// & WAQTD the employees names ends with "ar" or "or"
db.emp.find({ ename: { $regex: /.*ar$|.*or/ } },{ _id: 0, ename: 1 } ); // [] --> we can mention specific characters.
